...
public class customerDetailsBill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(39, 59, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1177, 50, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel2.setText("SEARCH BY CHECKOUT DATE");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(473, 122, -1, -1));
        ...
        getContentPane().add(checkOutDateTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(664, 115, 245, 29));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(944, 118, -1, -1));
        ...
        checkOutTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CUSTOMER_NAME", "ROOMNO", "MOBILE_NUMBER", "EMAIL", "CHECKIN_DATE", "CHECKOUT_DATE", "NUMBER_OF_DAYS_STAY", "PER_DAY_PAYMENT", "TOTALAMOUNT"
            }
        ));
        jScrollPane1.setViewportView(checkOutTable);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(39, 234, 1317, 492));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1058, 118, -1, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            String sql= " SELECT * FROM CUSTOMER_CHECKOUT_INFO WHERE CHECKOUT_DATE = '"+checkOutDate+"' " ;
           ...
           //Logger.getLogger(customerDetailsBill.class.getName()).log(Level.SEVERE, null, ex);
        }
 ...
 private void showAll() {
        try {
           ...
           // String checkOutDate = checkOutDateTextField.getText();
            ...
            String sql= " SELECT * FROM CUSTOMER_CHECKOUT_INFO " ;
            Statement st= con.createStatement();
            ResultSet rs= st.executeQuery(sql);
            checkOutTable.setModel(DbUtils.resultSetToTableModel(rs));
